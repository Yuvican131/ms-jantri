...
const MasterSheetDialog = ({ isOpen, onClose, savedSheetLog, draw }: { isOpen: boolean, onClose: () => void, savedSheetLog: SavedSheetInfo[], draw: string }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-7xl h-full flex flex-col">
                <DialogHeader>
                    <DialogTitle>Master Sheet - {draw}</DialogTitle>
                </DialogHeader>
...
const handleHarupApply = () => {
  ...
  return (
    <>
                ...
                <div className="border rounded-lg p-2 flex flex-col gap-2 mt-auto">
                    <div className="flex items-center gap-2">
                        ...
                        <Button onClick={handleRevertLastEntry} variant="outline" disabled={!previousSheetState || selectedClientId === null} size="sm" className="h-8 text-xs">
                         ...
                         <Button onClick={() => setIsMasterSheetDialogOpen(true)} variant="secondary" size="sm" className="h-8 text-xs">
      ...
      <MasterSheetDialog 
          isOpen={isMasterSheetDialogOpen} 
          onClose={() => setIsMasterSheetDialogOpen(false)}
